...
public class GenerateSimpleUpdateFunctionTests
{
...
[HttpFunction]
public class C {{
    public Outcome UpdateResource() {{
        return new Outcome(Status.Updated);
    }}
}}";
...
{{
    ...
    public HttpResponseData UpdateResource(
        [HttpTrigger(
    ...
    {{
        var outcome = _controller.UpdateResource();
