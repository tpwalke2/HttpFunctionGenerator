...
public class GenerateSimpleDeleteFunctionTests
{
...
{{
    ...
    public HttpResponseData DeleteResource(
        [HttpTrigger(
    ...
    {{
        var outcome = _controller.DeleteResource();
